  ...
  >
    <div class="box">
      <div class="partition" id="partition-register">
        <div class="partition-title">NUEVO CURSO</div>
        <div class="partition-form">
          <form autocomplete="false" v-on:submit="newCourse">
          ...
          <div class="button-set">
            <button v-on:click="newCourse">Crear curso</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    newCourse() {
      ...
      this.$http
        .post("/courses/new/", request)
        .then(response => {
          console.log(response.data);
          this.$modal.hide("create-courses");
          this.$router.go();
        })
        .catch(e => {
